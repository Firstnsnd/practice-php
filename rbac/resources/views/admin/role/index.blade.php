	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c"> 日期范围：
				...
				<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="role_create('添加管理员','/admin/role/create','1000','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a></span>  </div>
			<div class="mt-20">
							...
							<tr class="text-c">
								...
								<td>
									@if($role['id'] == 1)
									 所有权限
									@endif
									@if($role['pername_list'] != null)
										@foreach ($role['pername_list'] as $pernames)
											{{$pernames->pername}}
										@endforeach
									@endif
								</td>
